...
/**
 * Objects of this class store configuration data. <br>
 * 
 * The class provides functionality for extracting and setting
 * properties of objects.<br>
 * 
 * Additionally, there is a method for converting a Configuration
 * into a String for displaying purposes.<br>
 * 
 * Additionally, you can store and retrieve additional information
 * in a Configuration.
 *  
 * @author Kai, Michael
 */
