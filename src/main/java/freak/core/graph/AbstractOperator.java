...
/**
 * An abstract class implementing the interface <code>Operator</code>.
 * <code>AbstractOperator</code> provides a operator's basic
 * functionality and is to be used as a superclass for all operators.
 * 
 * Operators must implement the process and may implement the getInspector method. 
 * 
 * Operators may override checkSyntax() in the following way:
 * <pre>
 ...
 * }
 * </pre>
 * Also they may override the addInPort, addOutPort, removeInPort,
 * removeOutPort methods i.e. to limit the number of possible
 * ports or ensure a certain number of ports. Operators allowing their number of 
 * InPorts or OutPorts to change should implement HasFloatingNumberOfInPorts or 
 * HasFloatingNumberOfOutPorts, respectively.
 * 
