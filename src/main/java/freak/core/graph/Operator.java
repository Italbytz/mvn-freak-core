...
/**
 * A node in the operator graph where individuals are being processed.
 * 
 * All operators must provide a configurable name for identification in the
 * parameter controller setup.
 * 
