...
public class Schedule
        implements GenerationEventSource, RunEventSource, BatchEventSource, ScheduleEventSource,
        Serializable, ScheduleInterface {
    ...
    private ObserverManagerInterface observerManager = new ObserverManager();
    ...
    /**
     * @param factory the randomElementFactory to set
     */
    ...
    /**
     * @param criteria the new StoppingCriteria.
     */
